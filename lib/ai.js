...
export const AI_CONFIG = {
    voice: 'aria', // Professional, clear voice for support agent
    temperature: 0.4, // Slightly lower for more consistent, professional responses
    turn_detection: { 
        type: 'server_vad',
        threshold: 0.4, // More responsive to speech
